          ...
          <div className="container">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 items-center">
              ...
              <div className="flex flex-col justify-center gap-6 sm:pt-0 lg:px-16">
                ...
                >Find Beauty in Every Corner of the World
                ...
                >
                  From bustling cities to serene landscapes,discover the
                  hidden gems that make each destination unique. Every
                  journey offers a new perspective,revealing the stunning
                  diversity our world has to offer. 
